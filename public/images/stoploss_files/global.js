        ...
        $.getJSON('/user/balance', function( data ) {
            ...
            if(data.success == false){
                ...
                $.each(data.data.addresses, function(){
                    addressesBody += '<tr><td><div id="qrcode2" style="border-style: solid; border-width: 4px; border-color: #fff;" width="75px" height="75px"></div></td><td><a href="http://ganjacoin.cc:2750/address/'+data.data.addresses[i]+'" class="addressList" id="'+data.data.addresses[i]+'">'+data.data.addresses[i]+'</a><td></tr>';
                    label++;
                    i++;
