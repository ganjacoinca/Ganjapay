                    ...
                    if(password == req.body.passwordConfirm){
                        ...
                        User.findOne({ 'local.email' :  email }, function(err, user) {
                            ...
                            if (user) {
                                ...
                                newUser.wallets.ganjacoin.label = email;
                                newUser.wallets.ganjacoin.address = '';
                                newUser.wallets.ganjacoin.balance = '';
        ...
        if(validator.isEmail(email)){
            ...
            User.findOne({ 'local.email' :  email }, function(err, user) {
                ...
                if(user.local.verifiedEmail == false){
                    return done(null, false, req.flash('loginMessage', 'Please contact the admin to activate your beta account (josh@ganjacoin.cc).')); // req.flash is the way to set flashdata using connect-flash    
                }
